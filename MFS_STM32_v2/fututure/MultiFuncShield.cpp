...
// ----------------------------------------------------------------------------------------------------
unsigned int MFS_getSonarDataCm(byte triggerPin, byte echoPin)
{
...
// ----------------------------------------------------------------------------------------------------
void MFS_initPulseInCounter(byte pin, unsigned int timeOut, byte trigger)
{
...
void MFS_disablePulseInCounter ()
{
  pulseInEnabled = false;
}

// ----------------------------------------------------------------------------------------------------
unsigned int MFS_getPulseInPeriod()
{
  unsigned int period;
...
// ----------------------------------------------------------------------------------------------------
unsigned long MFS_getPulseInTotalCount()
{
  unsigned long count;
...
// ----------------------------------------------------------------------------------------------------
void MFS_resetPulseInTotalCount()
{
  pulseInWriteInProgress = 1;
  pulseInTotalCount_volatile = 0;
  pulseInTotalCount_safe = 0;
...
// ----------------------------------------------------------------------------------------------------
void MFS_setPulseInTimeOut(unsigned int timeOut)
{
  pulseInWriteInProgress = 1;
  pulseInTimeOut = timeOut;
  pulseInWriteInProgress = 0;
...
// ----------------------------------------------------------------------------------------------------
void MFS_queueButton (byte button)
{
...
// ----------------------------------------------------------------------------------------------------
void MFS_beep(unsigned int onPeriod, unsigned int offPeriod, byte cycles, unsigned int loopCycles, unsigned int loopDelayPeriod)
{
...
// ----------------------------------------------------------------------------------------------------
void MFS_setBeepOffPeriod(unsigned int offPeriod)
{
  beeperModifyInProgress = 1;  // must do this first before changing volatile fields.
...
// ----------------------------------------------------------------------------------------------------
//void MFS_setLedControlMask(byte controlMask)
//{
...
// ----------------------------------------------------------------------------------------------------
void MFS_writeLeds(byte leds, byte lit)
{
  if (lit)
  {
...
// ----------------------------------------------------------------------------------------------------
void MFS_blinkLeds(byte leds, byte enabled)
{
  if (enabled)
  {
...
// ----------------------------------------------------------------------------------------------------
void MFS_setDisplayBrightness(byte level)
{
...
// ----------------------------------------------------------------------------------------------------
void MFS_write(float number, byte decimalPlaces)
{
  char outstr[7];
...
// ----------------------------------------------------------------------------------------------------
void MFS_write(const char *text, byte rightJustify)
{
...
// ----------------------------------------------------------------------------------------------------
void MFS_blinkDisplay(byte digits, byte enabled)
{
  if (enabled)
  {
...
// ----------------------------------------------------------------------------------------------------
void MFS_setTimer(unsigned long thousandths)
{
...
// ----------------------------------------------------------------------------------------------------
void MFS_wait(unsigned long thousandths)
{
