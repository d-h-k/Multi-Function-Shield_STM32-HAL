...
#define __MULTI_FUNC_H__

/*=======================NUCLEO64-103RB Arduino Header Pin assignment begin=======================*/
//#ifndef __NUC64_103RB__
//#define __NUC64_103RB__
...
//#define KEY_GPIO_Port A0_GPIO_Port
//
//#define RS_Pin D8_Pin
//#define EN_Pin D9_Pin
//#define BL_Pin D10_Pin
//#define KEY_Pin A0_Pin  //ADC Switch

/*=======================MuitiFunction Shield begin=======================*/
#define SW1_GPIO_Port A1_GPIO_Port
#define SW2_GPIO_Port A2_GPIO_Port
#define SW3_GPIO_Port A3_GPIO_Port
#define LCH_GPIO_Port D4_GPIO_Port
#define SFT_GPIO_Port D7_GPIO_Port
#define SDI_GPIO_Port D8_GPIO_Port
#define LED4_GPIO_Port D10_GPIO_Port
#define LED3_GPIO_Port D11_GPIO_Port
#define LED2_GPIO_Port D12_GPIO_Port
#define LED1_GPIO_Port D13_GPIO_Port

#define SW1_Pin A1_Pin
#define SW2_Pin A2_Pin
#define SW3_Pin A3_Pin
#define LCH_Pin D4_Pin
#define SFT_Pin D7_Pin
#define SDI_Pin D8_Pin
...
extern volatile uint16_t LED1_Time;
extern volatile uint16_t LED2_Time;
extern volatile uint16_t LED3_Time;
extern volatile uint16_t LED4_Time;
